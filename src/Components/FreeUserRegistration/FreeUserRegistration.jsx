        ...
        <div className="row">
          <div className="col-xs-12 col-sm-4 register-left offset-1">
            ...
            <p>
              ...
              fuga eos, vitae optio ratione nemo distinctio nulla soluta
              accusantium exercitationem culpa nesciunt repudiandae officia id
              maiores impedit incidunt ut repellat!
            </p>
          </div>
