    ...
    try {
      let response = await fetch("http://localhost:3015/quiz/" + quizId, {
        headers: {
          ...
          Authorization:
            "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1ZGU5MmFlZjkzYTlhMzA4ODA1NGYzODEiLCJpYXQiOjE1NzU1NjE5NzcsImV4cCI6MTU3NTY0ODM3N30.YF3tVV3f8qo3T-ecD81xeunuqVTbadD8jeMJuc7DT18"
        }
      });
      if (response.ok) {
